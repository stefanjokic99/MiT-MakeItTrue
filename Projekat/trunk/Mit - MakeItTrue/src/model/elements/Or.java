...
/**
 * 
 * Klasa koja predstavlja logièko OR kolo
 *
 */
public class Or extends AbstractObject  {
	   
	   public Or(int xKoordinata, int yKoordinata, DifferentViewObject differentViewObject) {
   ...
   public void draw(Graphics g) {
	   ...
	   case "toolbox":
			...
			g2d.drawLine(pin1.x, pin1.y, point.x + 26, point.y + 10);//prvi pin
			g2d.drawLine(pin2.x, pin2.y, point.x + 26, point.y + 30);//drugi pin
