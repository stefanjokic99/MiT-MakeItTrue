/***********************************************************************
 * Module:  ToolboxContextMenu.java
 * Author:  G1
 ***********************************************************************/
...
/**Klasa koja definiše konteksni meni za paletu elemenata.**/
public class ToolboxContextMenu extends JPopupMenu {
	...
	/**Element konteksog menija za ANSI komponente.**/
	private JCheckBoxMenuItem ANSIelements = null;
	/**Element konteksog menija za IEC komponente.**/
